...
function DrawUI()
{
	...
	context.fillText("TIME:", 5, 634);
	context.fillStyle = "red";
	context.font="24px Impact";
	context.fillText(countUpTimer.toFixed(1).toString(), 60, 634);

	context.fillStyle = "red";
	context.font="24px Impact";
	context.fillText("SCORE:", 535, 634);
	context.fillStyle = "red";
	context.font="24px Impact";
	context.fillText(scoreCount.toFixed(1).toString(), 605, 634);
